        ...
        0 > a
          ? d
            ? ((e = this.endTime - this.startTime),
              ...
              (g = this.endTime + f * g),
              0 < f && 0 < h && g >= c && ((g = c), (d = c - e)),
              this.zoomToDates(new Date(d), new Date(g)))
            : (0 < f && 0 < h && this.end >= e - 1 && (h = f = 0),
              (d = this.start + h),
              (g = this.end + f),
          ...
          ? ((e = this.endTime - this.startTime),
            (d = this.startTime - h * g),
            (g = this.endTime - f * g),
            0 < f && 0 < h && d <= k && ((d = k), (g = k + e)),
            this.zoomToDates(new Date(d), new Date(g)))
          : (0 < f && 0 < h && 1 > this.start && (h = f = 0),
            (d = this.start - h),
            (g = this.end - f),
            this.zoomToIndexes(d, g));
      }
      ...
      this.rotate
        ? (isNaN(a) ||
            ...
            (this.relativeZoomValueAxes(this.valueAxes, a, b) &&
              this.updateAfterValueZoom()),
          e.vZoomEnabled && ((f = g.start), (l = g.end)))
        : (isNaN(c) ||
            isNaN(d) ||
            (this.relativeZoomValueAxes(this.valueAxes, c, d) &&
              this.updateAfterValueZoom()),
          e.hZoomEnabled && ((f = g.start), (l = g.end)));
      isNaN(f) ||
        isNaN(l) ||
        ((a = this.categoryAxis),

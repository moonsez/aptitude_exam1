...
<body class="page-header-fixed  page-sidebar-closed">
                            ...
                            <div class="portlet-body" style="height:500px;">
                                <div class="row" id="exam">
                                    <div class="col-md-12" style="margin-top: -40px;">
                                        ...
                                        <p style="font-size:18px; margin: 5px 0; padding: 5px 0; text-align:center;">All the best👍</p>
                                    </div>
    ...
    <script src="<?php echo base_url(); ?>js/attempt_test.js" type="text/javascript"></script>

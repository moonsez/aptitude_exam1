	...
	<form class="login-form" action="<?php echo base_url();?>login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" autocomplete="on" placeholder="Enter Your Email" name="username" id="useremail"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Enter Your Password" name="password" id="userpass"/>
			</div>
		</div>
		...
		<div class="create-account">
			 <p>
				<a href="<?php echo base_url();?>register_now">Create an account</a>
			</p>
		</div>
	</form>

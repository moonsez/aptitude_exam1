						...
						<div class="row form">
							<div class="portlet box blue-hoki">
								...
								<div class="portlet-body">
									<?php if (isset($internrecord) && !empty($internrecord)) { ?>
													...
													<tr class="odd gradeX">
														...
														<td style="text-align:center;">
															<span style="cursor: pointer;" class="tooltips"
																...
																<a href="<?php echo base_url(); ?>intern_view_results/<?php echo (isset($key->user_test_id) && !empty($key->user_test_id)) ? $key->user_test_id : ''; ?>"
																	;>
															...
															<!-- <span style="cursor: pointer;" class="tooltips"
																...
																<a href="<?php echo base_url(); ?>intern_download_certificate/<?php echo (isset($key->user_test_id) && !empty($key->user_test_id)) ? $key->user_test_id : ''; ?>"
																	;>

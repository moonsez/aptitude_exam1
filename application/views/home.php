									...
									<div class="table-scrollable table-scrollable-borderless">
										<table class="table table-hover table-light">
											...
											<tr>
												...
												<td>
													<a href="javascript:;"
														class="primary-link"><?php echo (isset($user_data->emp_name) && !empty($user_data->emp_name)) ? $user_data->emp_name : '' ?></a>
												</td>
											</tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:;"
                                                       class="primary-link"><?php echo (isset($user_data->dept_master_name) && !empty($user_data->dept_master_name)) ? $user_data->dept_master_name : '' ?></a>
                                                </td>
                                            </tr>
											<tr>
								...
								<div class="col-md-3">
									<?php if (!empty($test_data) && !empty($final_datetime) && date("Y-m-d H:i:s") > $final_datetime) { ?>
                                        <a type="button" class="btn green pull-right"
                                            ...
                                            Results</a>
                                    <?php } else if (empty($test_data) && !empty($final_datetime) && date("Y-m-d H:i:s") > $final_datetime) { ?>
                                        <a type="button" class="btn green pull-right"
                                           href="<?php echo base_url(); ?>user_test_res" style="float:center;">Test
                                            Results</a>
                                    <?php } else if (empty($test_data) && empty($final_datetime)) { ?>
                                        <a type="button" class="btn green pull-right"
                                           href="<?php echo base_url(); ?>user_test_res" style="float:center;">Test
                                            Results</a>
									<?php } ?>
								...
								<div class="col-md-3">
									<?php if (isset($test_data) && !empty($test_data) && !empty($final_datetime) && $final_datetime >= $test_data->test_datetime && date('Y-m-d H:i:s') <= $final_datetime) { ?>
										<a type="button" class="btn blue pull-right"
											href="<?php echo base_url(); ?>begin_test/<?php echo $user_data->user_id; ?>/<?php echo $test_data->test_configuration_id; ?>"

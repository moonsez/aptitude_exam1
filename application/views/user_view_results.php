									...
									<div class="note note-info note-shadow">
										...
										<table width="70%" style="margin-left:50px; width:91%; " class="table table-bordered">
											...
											<tr>
												...
												<td style="text-align:center;"><?php echo $obj_result->not_attended_count; ?> </td>
												...
												<td style="text-align:center;"><?php 
													...
													echo $tot_mark; ?></td>
													<td style="text-align:center;"><?php echo $obj_result->response_time; ?></td>
														...
														?>
															<?php if(isset($question_list) && !empty($question_list))
																...
																?>
																	...
																	<button class="btn btn-sm btn-primary toggle-exp" style="float:right ;" data-target="#exp<?= $question->question_id; ?>">
																		View Explanation
																	</button>

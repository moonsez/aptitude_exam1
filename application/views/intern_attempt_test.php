...
<head>
	...
	<style type="text/css">
		...
		@media (max-width: 767px) {
			...
			/* Set container to be full width */
			...
			/* Button groups and numbered question buttons */
			.btn-group {
				display: flex;
				flex-wrap: wrap;
				gap: 5px;
			...
			/* Hide sidebar countdown or place it above */
			.test_countdown {
				width: 100% !important;
				height: auto;
				margin-bottom: 10px;
																		...
																		<div class="col-md-6">
																			...
																			<?php } else { ?>
																				<button class="btn clear que_clear_res"
																					...
																					Response</button>
																				<button class="btn blue que_next_prev mob"
																					rel="<?php echo $k; ?>_<?php echo $i + 1; ?>"
																					type="button"
